...
export const Search = (props) => {
  ...
  return (
    ...
    {props.searchQueryDataLoading === true ? 
            ...
            <div>
              ...
              {auth !== null && (
                    <div className="like-dislike-buttons">
                      ...
                      <button className="add-collection" onClick={handleOpen}>
                       <svg
                         xmlns="http://www.w3.org/2000/svg"
                         fill="none"
                         viewBox="0 0 24 24"
        ...
        <SelectedCollections userSelectedInfo={props.searchQueryData} />
        ...
        props.searchQueryData.map((item) => {
          return (
            <Link to={`/userDetails/${item.username}`}>
            <div>
          ...
          {open && <ModalCollection handleClose={handleClose} open={open} />}
